...
Data = DataLoader()
Train_captions, Train_images, Train_feature, Train_lengths, img = Data.get_Training_data(400000)
Test_captions, Test_images, Test_feature, Test_lengths = Data.get_val_data(150000)
...
def main(args):
    ...
    for epoch in range(args.num_epochs):
        ...
        print('Epoch [{}/{}], Loss: {:.4f}, Perplexity: {:5.4f}, TestLoss: {:.4f}, TestPerplexity: {:5.4f}'
              .format(epoch, args.num_epochs, avgTrainLoss,
    ...
    Train_ouutput = sample.predict(Train_feature[0:15])
    Test_ouutput = sample.predict(Test_feature[0:15])
